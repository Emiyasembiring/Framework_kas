...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
                ...
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/pln.png" alt="home" /></b><span class="hidden-xs"><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/kk.png" alt="home" /></span></a></div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="#"> <img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/users/emiya.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?= $_SESSION['user'] ?></b> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo date('Y'); ?> &copy; KAS KEUANGAN</footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        ...
        $.toast({
            ...
            text: 'Aplikasi pengeloala Kas Keuangan Polinela.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3500,
